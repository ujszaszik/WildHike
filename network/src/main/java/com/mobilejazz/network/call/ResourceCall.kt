package com.mobilejazz.network.call
        ...
        object : Callback<Resource<R>> {
            ...
            override fun onResponse(
                ...
                if (response.code() == 401) {
                    val errorResource =
                        Resource.error<R>(message = ApiErrorCodes.UNAUTHORIZED.message)
                    Timber.i("Successfully handled Resource Call API response - 401 Unauthorized")
